                ...
                FirebaseDatabase.getInstance().getReference().child("allDoctors").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (!Boolean.parseBoolean(dataSnapshot.child("verified").getValue().toString())){
                                    Toast.makeText(RespondToQuery.this, "You are not a verified doctor.", Toast.LENGTH_SHORT).show();
                                }else{
